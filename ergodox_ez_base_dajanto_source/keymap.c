...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    DE_CIRC,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TG(1),                                          MO(1),          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           DE_SS,
    ...
    KC_LSHIFT,      DE_Y,           KC_X,           KC_C,           KC_V,           KC_B,           KC_INSERT,                                      DE_HASH,        KC_N,           KC_M,           KC_COMMA,       KC_DOT,         DE_MINS,        KC_RSHIFT,
    KC_LCTRL,       KC_LGUI,        KC_LALT,        KC_LALT,        KC_LCTRL,                                                                                                       KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_RALT,
                                                                                                    DE_LESS,        DE_MORE,        KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,
                                                                                                                    KC_HOME,        KC_PGUP,
                                                                                    KC_SPACE,       KC_LCTRL,       KC_END,         KC_PGDOWN,      KC_BSPACE,      KC_ENTER
  ),
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_HASH,        KC_DLR,         DE_LPRN,        DE_RPRN,        DE_GRV,                                                                         KC_DOWN,        KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_DELETE,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_UP,          KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
